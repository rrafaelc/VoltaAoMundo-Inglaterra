    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link" href="comentario.html">Deixe seu comentário</a>
          </li>
        </ul>
      </div>
    </div>
    ...
    <div class="card">
      <div class="card-body">
        ...
        try {
          ...
          echo "<p>Clique <a href='/comentarios.html'>aqui</a> para listar os comentários ou espere 5 segundos</p>";
