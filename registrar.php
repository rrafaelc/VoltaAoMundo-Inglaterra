...
<body>
  ...
  <main class="container my-5 pt-5">
    ...
    <form action="usuario-registrar.php" method="POST">
      <div class="form-outline mb-4">
        <label class="form-label" for="email">Email</label>
        <input id="email" name="email" type="email" class="form-control" placeholder="Digite um email" required />
      </div>

      <div class="form-outline mb-4">
        <label class="form-label" for="senha">Senha</label>
        <input id="senha" name="senha" type="password" class="form-control" placeholder="Digite uma senha" required />
      </div>

      <button id="botao-enviar" type="submit" class="btn btn-primary btn-block mb-4">Registrar</button>
